...
export default function Home() {
    ...
    return (
        <>
            <Head>
                <title>Perkins Industrial</title>
                <meta
                    name="viewport"
            ...
            33vw"
                ...
                <Description>
                    ...
                    <Text
                        ...
                        width="100%"
                    >
                        Perkins Industrial is your ultimate solution provider of
                        generators, switchgears, and electrical spare parts.
                        <br />
                        <br />
                        Committed to delivering satisfaction and competence, we
                        at Perkins Industrial strive to look after our clients’
                        energy needs.
                        <br />
                        <br />
                    </Text>
                ...
                <DeliverSectionDescription>
                    ...
                    <Flex direction="column">
                        ...
                        <Text
                            ...
                            style={{ width: '100%' }}
                        >
                            Great Experience For Building Construction & Outdoor
                            Projects
                        </Text>
                        <Flex justifyContent="start">
                            ...
                            >
                                ...
                                <IconTextContainer>
                                    ...
                                    />
                                    You get speed, flexibility and better
                                    control
                                    <br />
                                </IconTextContainer>
                            </Text>
            ...
            <WorkingSection>
                ...
                33vw"
                        ...
                        <Text
                            ...
                            margin="30px 10px"
                        >
                            Our diesel generators comprise of a Diesel Engine
                            coupled to an Alternator, mounted over a common base
                            frame with Anti-Vibration mounting
                        </Text>
                ...
                33vw"
                        ...
                        <Text
                            ...
                            mobileTextAlign="center"
                        >
                            <InnerText>Paint Factory</InnerText>{' '}
                        </Text>
                        <Text
                            fontSize="0.9rem"
                            mobileFontSize="0.9rem"
                ...
                33vw"
                        ...
                        <Text
                            ...
                            marginLeft="10px"
                        >
                            We provide quality and genuine spare parts paired
                            with efficient after-sales service to keep your
                            ...
                            <AboutSectionDescription>
                                ...
                                >
                                    ...
                                    <Text
                                        ...
                                        fontWeight="bold"
                                    >
                                        Here At Perkins Industrial, We Value
            ...
            <HospitalitySection>
                <Flex direction="column" justifyContent="center">
                    <HiUserGroup
                        style={{ color: 'rgb(1,44,90)', fontSize: '6rem' }}
                    />
                    <Text
                        style={{
                            color: 'rgb(1,44,90)',
                    ...
                    >
                        Trusted In Construction, Hospitality, and other
                    ...
                    >
                        Our projects are fully tested, background checked,
                        license validated and insured with a 100% satisfaction
                        guarantee.
                    </Text>
                    <Flex
                        justifyContent="center"
