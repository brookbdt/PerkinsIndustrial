          ...
          <Flex alignItems="start" gap="1.5rem">
            ...
            <AboutDescription>
              ...
              >
                ...
                supplies the best of these world-class tools. running every day
                or once a year, you can count on our people to create
                innovative, efficient and reliable solutions whatever your
                application. PERKINS INDUSTRIAL is the EXCLUSIVE DEALER for
                Perkins Generator set, UK. Perkins Industrial in the territory
                of Ethiopia. We in the process of establishing a Generator
                Manufacturing Plant right here in Ethiopia, Addis Ababa under
                Perkins Generator UK.
              </Text>
              <Text
                color="rgba(0, 48, 100, 1)"
                fontSize="1.3rem"
              ...
              >
                ...
                service and products. Our main objective being lighting up all
                of Africa with our high quality Generators.
              </Text>
              <Text
                color="rgba(0, 48, 100, 1)"
                fontSize="1.3rem"
              ...
              >
                ...
                wish to be recognized for the values that we stand for as a
                humble company
              </Text>
            </AboutDescription>
          </Flex>
              ...
              <Flex direction="column" alignItems="start">
                ...
                <Collapse accordion expandIconPosition="end">
                  <Panel header={"Dependable and Quality Products"} key="1">
                    <p>
                      Our generators are configured to meet your needs,
                      including choice of containment, cold weather packages and
                      trailer options. For ultimate flexibility, most of our
                      mobile generators come parallel-ready, enabling a scalable
                      approach to power – parallel up to 32 units. Our mobile
                      generators are manufactured to deliver the reliable power
                  ...
                  <Panel header={"End-to-End Customizable Solutions"} key="2">
                    <ScrollableContent>
                      <p>
                        ...
                        technicians on standby for any service requirement
                        across the country, and troubleshooting of engines to
                        keep your engine feeling great.{" "}
                      </p>
                    </ScrollableContent>
                  </Panel>
                </Collapse>
