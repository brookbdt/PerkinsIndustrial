            ...
            33vw"
                        ...
                        <AboutDescription>
                            ...
                            >
                                ...
                                generator set manufacturers to bring light,
                                warmth, protection and of course peace of mind
                                to thousands of people. Perkins Ethiopia now
                                supplies the best of these world-class tools.
                                running every day or once a year, you can count
                                on our people to create innovative, efficient
                                and reliable solutions whatever your
                                application. PERKINS INDUSTRIAL is the EXCLUSIVE
                                DEALER for Perkins Generator set, UK. Perkins
                                Industrial in the territory of Ethiopia. We in
                                the process of establishing a Generator
                                Manufacturing Plant right here in Ethiopia,
                                Addis Ababa under Perkins Generator UK.
                            </Text>
                            <Text
                                color="rgba(0, 48, 100, 1)"
                                fontSize="1.3rem"
                            ...
                            >
                                ...
                                main objective being lighting up all of Africa
                                with our high quality Generators.
                            </Text>
                            <Text
                                color="rgba(0, 48, 100, 1)"
                                fontSize="1.3rem"
                            ...
                            >
                                ...
                                Starting from Ethiopia, we wish to be recognized
                                for the values that we stand for as a humble
                                company
                            </Text>
                        </AboutDescription>
                    </Flex>
                        ...
                        <Flex alignItems="start">
                            <Flex direction="column" alignItems="start">
                                ...
                                <Collapse accordion expandIconPosition="end">
                                    <Panel
                                        header={
                                            'Dependable and Quality Products'
                                        }
                                        key="1"
                                    >
                                        <p>
                                            Our generators are configured to
                                            meet your needs, including choice of
                                            containment, cold weather packages
                                            and trailer options. For ultimate
                                            flexibility, most of our mobile
                                            generators come parallel-ready,
                                            enabling a scalable approach to
                                            power – parallel up to 32 units. Our
                                            mobile generators are manufactured
                                            to deliver the reliable power you
                                ...
                                <Collapse expandIconPosition="right">
                                    <Panel
                                        header={
                                            'Efficient and Expect Customer Support'
                                        }
                                        key="3"
                                    >
                                        <p>
                                            These are our core values: Integrity
                                            Quality Reliability Trust Teamwork
                                            With our every interaction within
                                            staff members and customers we will
                                            always exercise our core values.
                                        </p>
                                    </Panel>
                                </Collapse>
                            </Flex>
                        ...
                        <Flex justifyContent="space-between" background="#fff">
                            ...
                            <QuoteImageContaier>
                                <OurFacility>
                                    ...
                                    >
                                        {' '}
                                        Woreda 03, Bole Addis Ababa Zone,
                                        Ethiopia
                                    </Text>
                                </OurFacility>
                            </QuoteImageContaier>
